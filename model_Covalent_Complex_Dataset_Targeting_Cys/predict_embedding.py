...
protein_seq = pd.read_csv('screen/protein.csv',sep=',')['ProSeqs']
...
if __name__=='__main__':
    ...
    prot_embeddings1.to_csv('screen/screen_specs_protein.csv', index=False, sep=',')
    # x_pro = pd.read_csv('screen/screen_specs_protein.csv', sep=',', header=0)
    # x_drug = pd.read_csv('screen/screen_specs_drug.csv', sep=',', header=0)
    # X = pd.concat([x_pro, x_drug], axis=1)
    # X.to_csv('screen/screen_specs_complex1.csv', index=False, sep=',')
    print("finish")
